 ...
 *
 * This function calls getBestChildWithPruning to enable pruning
 */
...
/**
 * an expansion of get best child, that uses alpha-beta pruning
 * Returns the best child of the given state, resulting from the MiniMax computation up to maxDepth, using
 * pruning to get better run time
